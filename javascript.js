...
function startImage(image_num, canvasId){
  ...
  if(image_num == 1){
    ...
    hint_text.innerHTML = "HINT: 5 LETTERS"

    word = "music"

    var header_field = document.getElementById('headerButton1')
    ...
    var hint_text = document.getElementById('hint')
    hint_text.innerHTML = "HINT: 3 LETTERS"

    word = "cat"

    var header_field = document.getElementById('headerButton2')
    header_field.style.backgroundColor = '#037de7'
  }
  else if(image_num == 3){
    image_number = 3
    ...
    var header_field = document.getElementById('headerButton3')
    header_field.style.backgroundColor = '#037de7'
  }
  else if(image_num == 4){
    image_number = 4
    ...
    var header_field = document.getElementById('headerButton4')
    header_field.style.backgroundColor = '#037de7'
  }
  else if(image_num == 5){
    image_number = 5
    ...
    var hint_text = document.getElementById('hint')
    hint_text.innerHTML = "HINT: 4 LETTERS"
...
function resetWordContainer(){
  var word_cont = document.getElementById("word-container")
  word_cont.style.backgroundColor = "white"
  word_cont.style.borderColor = "#2196f3"
